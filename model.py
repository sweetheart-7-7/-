...
from deploy.python.preprocess import preprocess, Resize, Normalize, Permute, PadStride
from deploy.python.visualize import visualize_box_mask, lmk2out
...
def predict_image(detector, FLAGS):
...
def main(FLAGS):
    ...
    predict_image(detector, FLAGS)


class FlagsObject:
    def __init__(self, image_file='../data/demo.jpg'):
        self.model_dir = 'inference_model/yolov4_cspdarknet_voc'
